...
fun KeySelectorPanel(
    ...
    Column(modifier = Modifier.padding(TunarSpacing.lg)) {
        Text(
            "调性",
        ...
        for (row in 0..1) {
            Row(
                ...
                horizontalArrangement = Arrangement.spacedBy(TunarSpacing.sm),
            ) {
                for (col in 0..5) {
                    val pc = row * 6 + col
        ...
        Spacer(modifier = Modifier.height(TunarSpacing.xs))
